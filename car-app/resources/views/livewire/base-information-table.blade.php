<div class="card w-full shadow-xl pb-2" style="background: #1f2937">
    <div class="px-4 pt-2 flex justify-between mb-1 mt-2">
        ...
        @if (!$isEditMode)
            <a href="{{ route('base.information.manager', ['id' => $vehicleId]) }}"
                        ...
                        @if ($isEditMode)
                            <td>
                                <div class="d-flex gap-2">
                                    <button class="small text-success"
                                    ...
                                    <button button class="small text-error"
                                        ...
                                        wire:confirm="Are you sure you want to delete this item?"><!-- https://feathericons.dev/?search=trash2&iconset=feather -->
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                            height="24" class="main-grid-item-icon" fill="none"
                                            stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2">
